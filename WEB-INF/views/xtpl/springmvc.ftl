...
<#--
Custom Macro - ExtJS Resources
-->

<#macro ctx>${rc.contextPath}</#macro>
<#macro ctxJS><script type="text/javascript">var _g_ctx = "${rc.contextPath}";</script></#macro>

<#macro copyright date>
	<p>Copyright (C) ${date} HUAYI TECH. All rights reserved.</p>
</#macro>