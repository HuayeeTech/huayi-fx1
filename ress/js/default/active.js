(function ($, owner) {
    ...
    $("#sideNavbarToggler").on("click", function(){
    	owner.togglerSideNav();
    });
    ...
    $(".add2cart-notify").on("click", function() {
        $("body").append("<div class='bottom-notification animated fadeIn'>Added to cart successfully!</div>");
        $(".bottom-notification").delay(2000).fadeOut();
    });
